...
import com.capstone.order.exception.ResourceNotFoundException;
import com.capstone.order.model.Customer;
import com.capstone.order.model.Medicine;
import com.capstone.order.model.OrderItemResponse;
import com.capstone.order.model.OrderResponse;
import com.capstone.order.model.User;
...
public class OrderServiceImpl implements OrderService{
	...
	public OrderResponse getOrderDetails(int orderId) {	
		...
		Customer customer=userService.getUserDetailsById(userId);
		User user=new User();
		user.setUserId(customer.getUserId());
		user.setFirstName(customer.getLastName());
