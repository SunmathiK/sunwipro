...
public class OrderServiceTest {
	...
	@Mock
	private UserServiceConsumer CustomerService;
	...
	public void testSaveOrder() {
		...
		order3.setOrderDate(LocalDate.of(2024, 05, 05));
	...
	public void testGetAllOrder() {
		...
		order1.setOrderDate(LocalDate.of(2024, 5, 5));
		order1.setOrderStatus("pending");

		OrderItem orderItem1 = new OrderItem();
		orderItem1.setOrderItemId(1);
		orderItem1.setQuantity(2);
		orderItem1.setMedieId(3);
		orderItem1.setItemTotal(100);
