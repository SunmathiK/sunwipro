...
import com.capstone.medicine.exception.ResourceNotFoundException;
...
public class MedicineServiceTest {
	...
	@Mock
	com.capstone.medicine.repository.MedicineRepository medicineRepository;
	
	@Mock
	com.capstone.medicine.repository.CategoryRepository categoryRepository;
	
	
	@Test
	void testSaveMedicine() {
	    
		 com.capstone.medicine.entity.Medicine medicine = new com.capstone.medicine.entity.Medicine();
		    Category category = new com.capstone.medicine.entity.Category();
	...
	public void testGetAllMedicines() {
		...
		Medicine medicine = new Medicine();
		Category category = new Category();
		medicine.setMedieId(1);
		medicine.setMediName("dolo");
		medicine.setMediPrice(100);
		medicine.setMfd(LocalDate.of(2024, 05, 05));
		medicine.setEfd(LocalDate.of(2026, 05, 05));
		...
		medicine1.setMedieId(2);
		medicine1.setMediName("cipla");
		medicine1.setMediPrice(200);
		medicine1.setMfd(LocalDate.of(2024, 05, 05));
		medicine1.setEfd(LocalDate.of(2026, 05, 05));
		medicine1.setDescription("cold");
		category1.setCategoryId(2);
		category1.setCategoryName("cold");
